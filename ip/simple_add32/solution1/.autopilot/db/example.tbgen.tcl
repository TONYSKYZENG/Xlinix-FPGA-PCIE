...
set C_modelArgList {
	...
	{ ver int 8 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "a", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 8, "direction" : "READONLY", "offset" : {"in":32}, "offset_end" : {"in":39}} , 
 	{ "Name" : "b", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 8, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":47}} , 
 	{ "Name" : "c", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_ovld","bitwidth" : 8, "direction" : "READWRITE", "offset" : {"in":48, "out":56}, "offset_end" : {"in":55, "out":63}} , 
 	{ "Name" : "ver", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_vld","bitwidth" : 8, "direction" : "WRITEONLY", "offset" : {"out":64}, "offset_end" : {"out":71}} ]}
# RTL Port declarations: 
set portNum 20
set portList { 
	{ s_axi_BUS_A_AWVALID sc_in sc_logic 1 signal -1 } 
	{ s_axi_BUS_A_AWREADY sc_out sc_logic 1 signal -1 } 
	{ s_axi_BUS_A_AWADDR sc_in sc_lv 7 signal -1 } 
	...
	{ s_axi_BUS_A_ARADDR sc_in sc_lv 7 signal -1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_A_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "BUS_A", "role": "AWADDR" },"address":[{"name":"example","role":"start","value":"0","valid_bit":"0"},{"name":"example","role":"continue","value":"0","valid_bit":"4"},{"name":"example","role":"auto_start","value":"0","valid_bit":"7"},{"name":"a","role":"data","value":"32"},{"name":"b","role":"data","value":"40"},{"name":"c","role":"data","value":"48"}] },
	...
	{ "name": "s_axi_BUS_A_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "BUS_A", "role": "ARADDR" },"address":[{"name":"example","role":"start","value":"0","valid_bit":"0"},{"name":"example","role":"done","value":"0","valid_bit":"1"},{"name":"example","role":"idle","value":"0","valid_bit":"2"},{"name":"example","role":"ready","value":"0","valid_bit":"3"},{"name":"example","role":"auto_start","value":"0","valid_bit":"7"},{"name":"c","role":"data","value":"56"}, {"name":"c","role":"valid","value":"60","valid_bit":"0"},{"name":"ver","role":"data","value":"64"}, {"name":"ver","role":"valid","value":"68","valid_bit":"0"}] },
...
set ArgLastReadFirstWriteLatency {
	example {
		...
		ver {Type O LastRead -1 FirstWrite 0}}}
