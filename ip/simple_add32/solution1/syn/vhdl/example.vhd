...
architecture behav of example is 
    ...
    "example_example,hls_ip_2022_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k325t-fbg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.941000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=106,HLS_SYN_LUT=136,HLS_VERSION=2022_2}";
    ...
    signal ver_ap_vld : STD_LOGIC;
    signal ap_rst_n_inv : STD_LOGIC;
    signal add_ln30_fu_75_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    add_ln30_fu_75_p2 <= std_logic_vector(unsigned(a) + unsigned(c_i));
    ap_done <= ap_start;
    ...
    c_o <= std_logic_vector(unsigned(add_ln30_fu_75_p2) + unsigned(b));
    ...
    ver_ap_vld_assign_proc : process(ap_start)
    begin
        if ((ap_start = ap_const_logic_1)) then 
            ver_ap_vld <= ap_const_logic_1;
        else 
            ver_ap_vld <= ap_const_logic_0;
        end if; 
    end process;
